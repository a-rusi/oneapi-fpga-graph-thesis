...
// SystemVerilog created from ZTSZZ12parallel_bfsRSt6vectorIS_IiSaIiEESaIS1_EEENKUlRN2cl4sycl7handlerEE_clES8_EUlvE_B5_merge
...
module k0_ZTSZZ12parallel_bfsRSt6vectorIS_IiSaI0000clES8_EUlvE_B5_merge (
    ...
    output wire [0:0] out_c5_exe17,
    output wire [0:0] out_memdep_808,
    ...
    // out_c0_exe103(GPOUT,10)
    assign out_c0_exe103 = in_c0_exe103_0;

    // out_c0_exe115(GPOUT,11)
    assign out_c0_exe115 = in_c0_exe115_0;

    // out_c0_exe126(GPOUT,12)
    assign out_c0_exe126 = in_c0_exe126_0;

    // out_c0_exe91111(GPOUT,13)
    assign out_c0_exe91111 = in_c0_exe91111_0;

    // out_c5_exe17(GPOUT,14)
    assign out_c5_exe17 = in_c5_exe17_0;

    // out_memdep_808(GPOUT,15)
    assign out_memdep_808 = in_memdep_808_0;
